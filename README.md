...
[https://3dviewer.net/] for that. (This site will also let you flip the model when exporting and convert it to .obj too iirc)
Your object should have 22.222 triangles or less. I sincerely recommend it to have less, but feel free to push the limits,
...
If this worked, you should now have a file called triangles.txt int the same folder as your .obj and .py files.
...
I hope you have fun with my project, feel free to feedback it, and and check out my other stuff on scratch if you got time :3
